// src/pages/Reportes/ReporteEstructuras.jsx
import React, { useState, useEffect } from 'react'
import './ReportesComun.css'
import helpersService from '../../services/helpersService'
import reportesService from '../../services/reportesService'

const ReporteEstructuras = () => {
  ...
  const handleBuscar = async () => {
    setLoading(true)
    try {
      const datosObtenidos = await reportesService.getReporteEstructuras(filtros)
  ...
  const handleExportar = async () => {
    setExportando(true)
    try {
      await reportesService.exportarReporteEstructuras(filtros)
...
export default ReporteEstructuras
